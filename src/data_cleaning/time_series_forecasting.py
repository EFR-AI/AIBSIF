...
def create_dataset(window_size=6, train_size=0.8, val_size=0.1, test_size=0.1) :
    ...
    for i, file in enumerate(filanemes) :
        ...
        df.drop(columns=['Vitesse de vent'], axis=0, inplace=True)
        ...
        new = WindowGenerator(window_size, 1, 1, train_df, val_df, test_df, ['Altitude', 'Latitude', 'Longitude'])
