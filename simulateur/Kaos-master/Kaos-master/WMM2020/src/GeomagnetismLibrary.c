...
void MAG_PrintData(MAGtype_GeoMagneticElements GeomagElements,
        MAGtype_MagneticModel *MagneticModel)
{
    char DeclString[100];
    char InclString[100];
    ...
    if(MagneticModel->SecularVariationUsed == TRUE)
    {
        ...
        printf("%9.1f\t%9.1f\t%9.1f\t%9.1f\t%9.1f\t%9.1f\t%9.1f\n",GeomagElements.F, GeomagElements.H, GeomagElements.X, GeomagElements.Y, GeomagElements.Z, GeomagElements.Decl, GeomagElements.Incl);
    } else
    {
        MAG_DegreeToDMSstring(GeomagElements.Decl, 2, DeclString);
